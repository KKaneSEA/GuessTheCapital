...
function App() {
  ...
  return (
    <div className="App-container">
      ...
      <div className="App-title"> OK</div>
      <div className="App-count-container">
        <h1 className="App-count">Right Guesses: {countRight} </h1>
        <h1 className="App-count"> Wrong Guesses: {countWrong}</h1>
